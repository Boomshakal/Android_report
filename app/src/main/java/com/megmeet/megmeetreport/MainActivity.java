...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String macAddress = InformationUtils.getInformationUtils(MainActivity.this).getMacAddress();
        Toast.makeText(this, "macaddress:" + macAddress, Toast.LENGTH_SHORT).show();

        webview.loadUrl("https://10.3.1.11:8075/WebReport/ReportServer?reportlet=MEGMEET%2Fproduct%2Fwipdata.cpt");
