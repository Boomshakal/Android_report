...
public class ReportFragment extends Fragment implements SpeechSynthesizerListener {
    ...
    public static ReportFragment newInstance(SQLBean sqlBean) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = View.inflate(getContext(), R.layout.fragment_report, null);
...
//            @Override
//            public void run() {
////                if (new Date().getTime() - cur_date.getTime() > 20 * 60 * 1000) {    //大于十秒
//                Log.e("len", "语音时间： " + new Date());
//                cur_date = new Date();
//                speak();
////                }
//            }
//        };
//        if (hasVoice != null && hasVoice.equals("Y")) {
//            timer.schedule(timerTask, 5, SPEAKTIME);
//        }
        speak();
        initWebView();
        return view;
...
//                        }
                    ...
                    mSpeechSynthesizer.setSpeechSynthesizerListener(ReportFragment.this);
                }
            }.start();
        }
    }
